        ...
        <?php
          ...
          ?>
            <tr>
              ...
              <td class="text-center" style="border: 1px solid black !important;"><?php if($getattd->DEA_IN_TIME!=''){ echo $getattd->DEA_IN_TIME; }else{ echo "--"; } ?>
              </td>
              <td class="text-center" style="border: 1px solid black !important;"><?php if($getattd->DEA_OUT_TIME!=''){ if(date('h:i A',strtotime($getattd->DEA_OUT_TIME))< date('h:i A',strtotime("6:00 PM")) ){ echo $getattd->DEA_OUT_TIME; }else{ echo "6:00 PM"; } }else{ echo "--"; } ?>
              </td>
              <td class="text-center" style="border: 1px solid black !important;"><?php if($getattd->DEA_CURRENT_LOCATION!=''){ echo $getattd->DEA_CURRENT_LOCATION; }else{ echo "--"; } ?>
              </td>
