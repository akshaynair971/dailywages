    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-responsive table-striped display" style="width:100%;">
            <thead>
              <tr>
                <th class="text-center">SR.NO</th>
                <th class="text-center">PAYROLL RATE</th> 
                ...
                <th class="text-center">ESIC EMPLOYEE</th>
                <th class="text-center">ESIC EMPLOYER</th>
                <th class="text-center">NET WAGES PAYABLE</th>
                <!-- <th class="text-center">ENTRY CREATED</th>
                <th class="text-center">LAST UPDATAED DATE</th> -->
            ...
            ?>
              <tr>                
                ...
                <td class="text-center"><?php echo date('d-M-Y',strtotime($row->DPM_VALID_FROM)); ?></td>
                <td class="text-center"><?php echo date('d-M-Y',strtotime($row->DPM_VALID_TO)); ?></td>
                <td class="text-center"><?php echo $row->DPM_BASIC_SALARY; ?></td>
                <td class="text-center"><?php echo $row->DPM_HRA; ?></td>
                <td class="text-center"><?php echo $row->DPM_OTHER_ALLOWANCE; ?></td>
