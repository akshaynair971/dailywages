  ...
  {  
    ...
    if($('#attd_date').val()==''){
      ...
      $.ajax({
        url: 'ajax.php',
        type: 'POST',
        data: {attd_date:attd_date,DEA_IN_TIME:DEA_IN_TIME,DEA_OUT_TIME:DEA_OUT_TIME,DEA_CURRENT_LOCATION:DEA_CURRENT_LOCATION,DEA_REMARK:DEA_REMARK,DEA_SIGN:DEA_SIGN,DEM_EMP_ID:DEM_EMP_ID,<?php if($_SESSION['user_type']==1){ echo "DEA_ID:DEA_ID,"; } ?>take_attendance:1},
        dataType: 'html'
      })
      .done(function(data){
        // console.log(data);  
