          ...
          <form method="POST" action="" enctype="multipart/form-data">
            <div class="col-md-12 col-sm-12 col-xs-12">   
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control DEM_EMP_DOB" id='datepicker1'  name='DEM_EMP_DOB' placeholder="Choose Date Of Birth" value="<?php if(isset($user_edit)){ echo $user_edit->DEM_EMP_DOB; } ?>" required autocomplete="off" onchange="GetAge();" readonly>
              </div>              
